...
inputFrame.pack(padx=5,fill="x", expand=True)  

#make label
inputLabel = ttk.Label(inputFrame, text="Prediksi Prodi")
inputLabel.pack(padx=10, pady=10, fill="x", expand=True)

#input nama siswa
labelInputNama = ttk.Label(inputFrame, text="Masukkan Nama")
...
labelInputInggris = ttk.Label(inputFrame, text="Masukkan nilai bahasa inggris")
...
def dataEntry():
    ...
    conn = sqlite3.connect('inibaru.db')
    cursor = conn.cursor()
